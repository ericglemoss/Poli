...
void Tasks() {
    ...
    printf("A matriz 'W' do item A apos sucessivas aplicacoes da Rotacao de Givens, devido ao seu tamanho extenso, tera mostrada apenas sua diagonal principal. \n \n");

    printf("A diagonal principal da matriz 'W' rotacionada do item A sera: \n \n");
    ...
    printf("A matriz 'W' do item C apos a utilizacao da funcao de resolucao de sistemas multiplos, devido ao seu tamanho, tera mostrada apenas sua diagonal principal. \n \n");

    printf("A diagonal principal da matriz W rotacionada do item C sera: \n");
    ...
    printf("A matriz W resultante do processo de fatoracao sera: \n \n");
...
double** Train_Matrix(int n, int m, int p, char *arquivo){
 ...
 int main (){
    ...
    //Como o treino dos dígitos já foi realizado, abre-se o arquivo de testes para leitura dos dados presentes no mesmo.
    ...
    //Número de acertos da máquina em relação aos dígitos analisados.
    int scores = 0;

    //O número de acerto relativo a cada dígito é salvo em uma posição do vetor correct_digit. A primeira posição faz referência do dígito "0".
    int correct_digit[10];

    //O número total de análises para cada dígito é salvo em cada posição do vetor total_digits. A primeira posição faz referência ao dígito "0".
    int total_digits[10];
    ...
    //Impressão da porcentagem geral total de acertos (precisão) da máquina.
    printf("%6d/%5d corretos - %lf%%\n\n", scores, n_test, (double) scores/n_test * 100);
